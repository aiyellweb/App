...
<header class="main-header">
  ...
  <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
    <h3>Listado de Arl <a href="{{route('arl.create')}}"><button class="btn btn-success" role="button">Nuevo</button></a></h3>

    <a href="{{route('eps-reporte')}}"><button class="btn btn-info" role="button">Reporte Arl</button></a>
          ...
          <tbody>
            @foreach($arl as $arls)
              <tr>
                ...
                <td>
                  {{ strtoupper($arls->descripcion) }}
                </td>
                <td>
                  <a href="" data-target="#modal-edit-{{$arls->id}}" data-toggle="modal"><button class="glyphicon glyphicon-edit"> <span class=""></span></button></a>
                    @include('arl.modaledit')
                  </a>
                </td>
                <td>
                  <a href="" data-target="#modal-delete-{{$arls->id}}" data-toggle="modal"><button class="btn btn-danger"> <span class="glyphicon glyphicon-trash"></span></button></a>
