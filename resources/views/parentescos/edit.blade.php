...
{!!Form::model($paren,['route'=>['parentescos.update',$paren],'method'=>'PUT'])!!}
...
<div class="form-group{{ $errors->has('codigo_parentesco') ? ' has-error' : '' }}" >
  ...
  {!!form::text('codigo_parentesco',$paren->codigo_parentesco,null,['class'=>'form-control','placeholder'=>'digite Codigo','required'])!!}
...
<div class="form-group{{ $errors->has('descripcion_parentesco') ? ' has-error' : '' }}" >
  ...
  {!!form::text('descripcion_parentesco',$paren->descripcion_parentesco,null,['class'=>'form-control','placeholder'=>'digite descripcion','required'])!!}
