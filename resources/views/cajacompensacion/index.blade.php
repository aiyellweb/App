...
<header class="main-header">
  ...
  <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
    <h3>Listado Cajas de compensacion <a href="{{route('cajacompensacion.create')}}"><button class="btn btn-success" role="button">Nuevo</button></a></h3>

    <a href="{{route('eps-reporte')}}"><button class="btn btn-info" role="button">Reporte caja compensacion</button></a>
          ...
          <tbody>
            @foreach($caja as $cajas)
              <tr>
                ...
                <td>
                  {{ strtoupper($cajas->descripcion_caja) }}
                </td>
                <td>
                  <a href="" data-target="#modal-edit-{{$cajas->id}}" data-toggle="modal"><button class="glyphicon glyphicon-edit"> <span class=""></span></button></a>
                    @include('cajacompensacion.modaledit')
                  </a>
                </td>
                <td>
                  <a href="" data-target="#modal-delete-{{$cajas->id}}" data-toggle="modal"><button class="btn btn-danger"> <span class="glyphicon glyphicon-trash"></span></button></a>
                   
                  </a>
                </td>
              </tr>
             
          @include('cajacompensacion.modal')
