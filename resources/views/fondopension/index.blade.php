...
<header class="main-header">
  ...
  <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
    <h3>Listado de Fondos de Pension <a href="{{route('fondopension.create')}}"><button class="btn btn-success" role="button">Nuevo</button></a></h3>
...
-->
          ...
          <br>
          <br>
        <table id="fondo_table" class="table table-striped table-bordered table-hover">
          <thead>
            <tr>
              <th>CÓDIGO</th>
              <th>NIT</th>
          ...
          <tbody>
            @foreach($fondo as $fondos)
              <tr>
                <td>
                  {{$fondos->codigo_fondo_pension}}
                </td>
                <td>
                  {{$fondos->nit_fondo_pension}}
                </td>
                <td>
                  {{ strtoupper($fondos->descripcion_fondo_pension) }}
                </td>
                <td>
                
                  <a href="" data-target="#modal-edit-{{$fondos->id}}" data-toggle="modal"><button class="glyphicon glyphicon-edit"> <span class=""></span></button></a>
                   
                  </a>
                  @include('fondopension.modaledit')
                </td>
                <td>
                  <a href="" data-target="#modal-delete-{{$fondos->id}}" data-toggle="modal"><button class="btn btn-danger"> <span class="glyphicon glyphicon-trash"></span></button></a>
                   
                  </a>
                  @include('fondopension.modal')
                </td>
              </tr>
